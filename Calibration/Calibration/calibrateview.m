...
- (void) drawWheel {
    ...
    container = [[UIView alloc] initWithFrame:CGRectMake(150, 50, 200, 200)];
    
    UIImageView *bgcolor = [[UIImageView alloc] initWithFrame:self.frame];
    bgcolor.backgroundColor = [UIColor colorWithRed:0. green:0. blue:0. alpha:0.7];
    ...
    im.layer.anchorPoint = CGPointMake(0.0f, 0.0f);
    ...
    //bkg images 
    UIImageView *rev = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 200, 200)];
    ...
    //bkg images 
    UIImageView *rev2 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 200, 200)];
    ...
    UIImageView *bg = [[UIImageView alloc] initWithFrame:CGRectMake(150, 50, 200, 200)];
    ...
    turnoffButton = [[UIButton alloc] initWithFrame:CGRectMake(400, 250, 45, 45)];
    ...
    turnoffButton.backgroundColor = [UIColor colorWithRed:255. green:255. blue:255. alpha:0.5];
