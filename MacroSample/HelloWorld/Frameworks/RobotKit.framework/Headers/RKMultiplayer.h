...
/*! A place to store a pointer should your multiplayer code need to.  Not used by RKMultiplayer internally */
@property (nonatomic, assign) id                                    multiplayerStartDelegate;
...
/*! The data encoding/decoding layer */
@property (nonatomic, retain) RKMultiplayerDataJSON                 *dataLayer;
 ...
 *  Will not notify other remote players.
 */
-(void)endGame;
...
/*! Sent when a message was sent to another player but the remote player
 *  did not acknowledge its receipt.
 *  @param player RKRemotePlayer that did not acknowledge receipt of the message.
 */
-(void)multiplayerPlayerDidNotRespond:(RKRemotePlayer*)player;
